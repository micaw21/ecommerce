            ...
            <div class="container text-center">
                <form action="<?php echo base_url('agregarCategoria'); ?>" method="post">
                    ...
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="text" name="descripcion" class="form-control" placeholder="Ingrese la descripción de la categoria" aria-label="descripcion" aria-describedby="addon-wrapping">
                    </div>
